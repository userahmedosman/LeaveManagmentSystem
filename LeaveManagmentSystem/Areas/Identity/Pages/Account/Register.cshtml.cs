...
namespace LeaveManagmentSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Length(2, 15, ErrorMessage = "First name should be at least 2 chars or maximum 15 chars")]
            [Display(Name = "First name")]
            public string FirstName { get; set; }


            [Required]
            [Length(2, 15, ErrorMessage = "Last name should be at least 2 chars or maximum 15 chars")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var non_admin_roles = await _roleManager.Roles
                .Select(r => r.Name)
                .Where(r => r != Roles.Admin)
                .ToArrayAsync();
...
;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(Input.Role == Roles.Supervisor)
                    {
